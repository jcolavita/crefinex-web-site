...
function Pilars({ ...props }) {
  return (
    <div className="  text-black text-center mt-10 flex flex-col items-center w-[350px]">
      ...
      <div className="z-10 flex flex-col items-center">
        ...
        <div className=" flex w-full h-24  items-center justify-center">
          <h4 className="font-medium md:text-3xl text-xl my-4 ">
            {props.title}
          </h4>
        </div>

        <p className=" md:text-base text-sm mb-2">{props.description}</p>
