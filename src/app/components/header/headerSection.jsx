    ...
    >
      <div className="h-auto flex flex-co md:w-[55%] w-auto md:pr-10 text-center md:text-left items-center relative ">
        ...
        <div className=" h-auto relative z-10 animate-jump-in animate-once animate-duration-[800ms] animate-delay-300">
          ...
          <button className=" md:w-auto px-5 w-full py-3 bg-gradient-to-br from-PRIMARY-400 to-BLUE-700 rounded-lg lg:hover:scale-105 transition-all ease-in-out duration-200 ">
            <Link
      ...
      <div className="  md:h-full  md:w-[45%] w-auto relative animate-jump-in animate-once animate-duration-[800ms] animate-delay-300 ">
        <div className=" hidden  lg:block w-[150px] h-[150px] animate-blob animation-delay-4000 rounded-3xl absolute left-0 top-5 bg-YELLOW-500  shadow-slate-800 shadow-md"></div>
        <div className=" hidden  lg:block w-[170px] h-[170px] animate-blob animation-delay-3000 rounded-3xl absolute -right-4 -top-0 bg-ORANGE-600 shadow-slate-800 shadow-md "></div>
        <div className=" hidden  lg:block w-[150px] h-[150px] animate-blob animation-delay-2000 rounded-3xl absolute left-0 bottom-10 bg-SKYBLUE-600 shadow-slate-800 shadow-md"></div>
        <div className=" hidden lg:block w-[160px] h-[160px] animate-blob animation-delay-1000 rounded-3xl absolute right-0 bottom-5 bg-GREEN-600 shadow-slate-800 shadow-md"></div>
        <div
          className={`lg:w-[320px] lg:h-[350px] w-[280px] h-[300px] lg:animate-blob rounded-3xl absolute right-0 left-0 md:top-0 md:bottom-0 top-5 m-auto
            bg-gradient-to-br from-PRIMARY-100 to-BLUE-600 shadow-slate-800 shadow-md `}
        >
