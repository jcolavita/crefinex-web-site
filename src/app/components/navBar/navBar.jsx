...
export default function NavBar() {
  ...
  return (
    ...
    >
      ...
      <ul
        className={`flex flex-col md:flex-row justify-between gap-y-4 py-4 md:py-0 bg-BLUE-700 z-10 md:bg-transparent   md:static absolute md:w-auto w-full left-0 transition-all ease-in-out duration-500 md:opacity-100${
